/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82facef37e9e07b51484afdfa90bd5db)
// Runtime types generated with workerd@1.20260721.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: "https://replace-me.example.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "SIGN_UP_ENABLED" | "PASSWORD_RESET_EMAIL_FROM" | "TRUSTED_ORIGINS" | "BETTER_AUTH_SECRET">> {}
}
